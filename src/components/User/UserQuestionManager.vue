...
async function fetchMyQuestions(page = 1) {
    ...
    try {
        const response = await fetch(`https://polyculture-back.axithem.fr/my-questions?page=${page}`, {
            method: "GET",
            headers: {
...
async function fetchMyPools() {
    ...
    try {
        const response = await fetch("https://polyculture-back.axithem.fr/my-pools", {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`,
...
async function fetchThemes() {
    ...
    try {
        const response = await fetch("https://polyculture-back.axithem.fr/themes", {
            method: "GET",
        });
